...
const translations = {
  en: {
    ...
    wallet: {
      ...
      addFirstBank: "Add Your First Account",
      primary: "Primary",
      ...
      notesPlaceholder: "e.g. November Sales Payout",
  ...
  ar: {
    ...
    forgotPassword: {
      ...
      cancel: "إلغاء",
      successMsg: "إذا كان الحساب موجوداً لهذا البريد الإلكتروني، فقد تم أرسال رابط إعادة تعيين كلمة المرور.",
    ...
    wallet: {
      ...
      notesPlaceholder: "مثال: دفعة مبيعات نوفمبر",
